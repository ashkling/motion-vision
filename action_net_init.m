...
f=1/100 ;
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(7,7,768,4096, 'single'), zeros(1, 4096, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 2) ;
net.layers{end+1} = struct('type', 'pool', ...
                           'method', 'max', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,4096,4096, 'single'),zeros(1,4096,'single')}}, ...
                           'stride', 1, ...
                           'pad', 2) ;
net.layers{end+1} = struct('type', 'pool', ...
                           'method', 'max', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,4096,1000, 'single'),  zeros(1,1000,'single')}}, ...
                           'stride', 1, ...
                           'pad', 2) ;
net.layers{end+1} = struct('type', 'relu') ;
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(30,30,1000,1000, 'single'), zeros(1,1000,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;

...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(2,2,768,100, 'single'), zeros(1, 100, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(2,2,100,50, 'single'),  zeros(1,50,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'pool', ...
                           'method', 'max', ...
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,1,50,4, 'single'),  zeros(1,4,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'relu') ;
